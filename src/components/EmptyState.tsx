  ...
  if (!lastUpdated && isScanning) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center py-12 px-6 text-center">
        ...
        <p className="text-[12px] font-medium text-surface-500 dark:text-surface-400 mb-1">
          Scanning...
        </p>
        <p className="text-[11px] text-surface-400 dark:text-surface-500 leading-relaxed max-w-[200px]">
